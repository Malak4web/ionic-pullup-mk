...
export class IonicPullupComponent {
    ...
    collapse(isInit = false) {
         ...
         * @return {?}
         */
        () => this.updateIonContentHeight(this.minBottomVisible - this.footerMeta.lastPosY)), 300);
        if (!isInit) {
...
/** @nocollapse */
IonicPullupComponent.ctorParameters = () => [
    { type: Platform },
    { type: Renderer2 },
